"""Image/Video Readers Module.

This module serves as a factory for creating image and video reader objects. It provides
...
Classes:
- ImageReader: Handles reading and processing of image files from various formats.
...
class ImageReaderMode(StrEnum):
    """Enumeration representing different modes for image readers."""
